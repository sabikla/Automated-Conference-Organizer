                ...
                <div class="col-sm-12">
                  <div class="list-group">
                    ...
                    <div class="list-group-item">
                        ...
                        <a type="submit" class="btn btn-danger btn-sm right" href="../doActionOnAbstract/reject/<?php echo md5($abstract['absID']); ?>">
                      		<span class="glyphicon glyphicon-remove"></span> Reject
                    	</a> 
                        <a class="btn btn-success btn-sm right" href="../doActionOnAbstract/accept/<?php echo md5($abstract['absID']); ?>">
                      		<span class="glyphicon glyphicon-ok"></span> Accept
                    	</a> 
                        <a class="btn btn-info btn-sm right" target="_blank" href="../doActionOnAbstract/download/<?php echo md5($abstract['absID']); ?>">
